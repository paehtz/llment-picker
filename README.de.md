...
| **Alt, Strg oder R antippen** (drücken und loslassen, ohne Klick) | schaltet den Modus scharf: der Chip leuchtet dauerhaft, der nächste Klick oder das Lasso löst aus – die Taste muss beim Zielen nicht gehalten werden. Nochmal antippen schaltet ab |
