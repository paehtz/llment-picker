...
npx --yes web-ext lint --source-dir . --ignore-files "dist/**" "chrome/**" "store/**" "test/**" "build.ps1" "README.md" "README.de.md" "PRIVACY.md" "LICENSE" ".gitignore" "icons/icon.svg"
npx --yes web-ext build --source-dir . --artifacts-dir dist/firefox --overwrite-dest --ignore-files "dist/**" "chrome/**" "store/**" "test/**" "build.ps1" "README.md" "README.de.md" "PRIVACY.md" "LICENSE" ".gitignore" "icons/icon.svg"
